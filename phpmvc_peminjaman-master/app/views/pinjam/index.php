...
<body>
<div class="container">
    <h3 class="mb-3">Nama Peminjaman</h3>
    <div class="d-flex justify-content-between">
    <div>
    <a href="<?= BASE_URL;?>/Pinjam/tambah" class="btn text-white" style="background-color: #000000;"><i class="fa-solid fa-plus"></i> Tambah Barang</a>
    </div>
    <div class="d-flex">
                ...
                <tr>
                  ...
                  <td>
                    <?php
                        ...
                        echo '<div style="background-color: #64CCC5; height: 1.7rem; text-align: center; color: white; margin-top: 0.5rem; border-radius: 7px;"> ' . $status .' </div>';
                        }elseif ( $selisih_hari > 2) {
                        $status = "sudah kembali" ;
                        echo '<div style="background-color: #176B87; height: 1.7rem; text-align: center; color: white; margin-top: 0.5rem; border-radius: 7px;"> ' . $status .' </div>';
                        } 
                        else {
                        $status = "belum kembali" ;
                        echo '<div style="background-color: #DAFFFB; height: 1.7rem; text-align: center; color: white; margin-top: 0.5rem; border-radius: 7px;">' . $status .' </div>';
                        }
                    ?>
                  </td> 
                  <td> 
